...
| 화면 | 식별자 | 책임 |
|---|---|---|
| Activity Log | PIPACTLOGS01 | 모든 입력의 시작점 |
| Position | PIPPOSHLDS01 | 보유 자산 집계 |
| Dashboard | PIPDASHS01 | 요약/비중 시각화 |
| Asset Detail | PIPASSETS01 | 종목별 상세 |
| Exchange | PIPFXS01 | 환전 입력 |
