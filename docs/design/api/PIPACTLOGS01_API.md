...
### 4.2 단건 조회
`GET /api/pip/transactions/{transactionId}`

---

### 4.3 생성
`POST /api/pip/transactions` → **201 Created**

---

### 4.4 수정
`PUT /api/pip/transactions/{transactionId}` → **200 OK**
...
### 4.5 삭제 (Soft Delete)
`DELETE /api/pip/transactions/{transactionId}` → **204 No Content**

---

## 5. CSV 업로드

`POST /api/pip/transactions/upload`
