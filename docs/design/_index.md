...
### 0.5 구현 파일 네이밍 & 헤더 주석 표준
- 화면 전용 구현 파일은 파일명에 ScreenID를 반드시 포함한다. (예: `PIPASSETS01.api.js`)
- 화면 전용 구현 파일 최상단에는 표준 헤더 주석 블록을 반드시 추가한다.
- 공용 파일(여러 화면에서 재사용되는 파일)은 ScreenID를 파일명에 포함하지 않는다.
- 본 규칙은 기능 추가 목적이 아니라 구현-문서 간 추적성 강화 목적이다.
...
|---|---|---|---|---|---|
| **PIPACTLOGS01** | [MODEL](./model/PIPACTLOGS01_MODEL.md) | [UI](./ui/PIPACTLOGS01_UI.md) | [API](./api/PIPACTLOGS01_API.md) | [DB](./db/PIP_DB_SNAPSHOT.md) | 모든 투자 활동의 단일 원장 입력/관리(매수/매도/배당/이자/입출금/세금/수수료/환전 포함) |
| **PIPMETAMST01** | [MODEL](./model/PIPMETAMST01_MODEL.md) | [UI](./ui/PIPMETAMST01_UI.md) | [API](./api/PIPMETAMST01_API.md) | [DB](./db/PIP_DB_SNAPSHOT.md) | 메타 정보 관리 (자산/계좌) |
| **PIPPOSHLDS01** | [MODEL](./model/PIPPOSHLDS01_MODEL.md) | [UI](./ui/PIPPOSHLDS01_UI.md) | [API](./api/PIPPOSHLDS01_API.md) | [DB](./db/PIP_DB_SNAPSHOT.md) | 포지션(계좌/자산/현금) 조회 – 원장 기반 계산 결과, 계산값 저장 금지 |
| **PIPDASHS01** | [MODEL](./model/PIPDASHS01_MODEL.md) | [UI](./ui/PIPDASHS01_UI.md) | [API](./api/PIPDASHS01_API.md) | [DB](./db/PIP_DB_SNAPSHOT.md) | 대시보드(요약/시각화) – 계산값 저장 금지, 조회 중심 |
| **PIPFXS01** | [MODEL](./model/PIPFXS01_MODEL.md) | [UI](./ui/PIPFXS01_UI.md) | [API](./api/PIPFXS01_API.md) | [DB](./db/PIP_DB_SNAPSHOT.md) | 환전(FX) 관리/입력/조회 |
